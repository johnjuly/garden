...
![[Pasted image 20251221092608.png]]

- token<class,string>
- 标点符号自己一个就是一个类
- 3个组合成一个whitespace
![[Pasted image 20251221092651.png]]
...
![[Pasted image 20251221092716.png]]
- do是关键字还是变量名。需要从左往右lookahead,看到,才知道是什么
- 最小化lookahead数量，最好限制在某个常量。


![[Pasted image 20251221092737.png]]
### PL/1 programming languages 1:ibm

- feature: keywords are not reserved
- keyword 与variable
![[Pasted image 20251221092801.png]]

- 因为declare后面的参数数量不确定 所以lookahead的数量也是不确定的

![[Pasted image 20251221092820.png]]

- 嵌套的模板 添加空格修复此法分析
![[Pasted image 20251221092840.png]]
    

![[Pasted image 20251221092923.png]]
![[Pasted image 20251221093002.png]]

## Regular languages


![[Pasted image 20251221093045.png]]
- base
	- single character
	- epsilon
- compound
![[Pasted image 20251221093139.png]]
    
- union
- concatenation
- iteration:A*=A^i i>=0

![[Pasted image 20251221093238.png]]

  
![[Pasted image 20251221093254.png]]
